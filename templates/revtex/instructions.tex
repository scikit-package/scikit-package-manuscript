...
Note that the citations were both compressed and sorted. Furthermore, running this sample file under the \texttt{prb} option will move the punctuation to the correct place.
